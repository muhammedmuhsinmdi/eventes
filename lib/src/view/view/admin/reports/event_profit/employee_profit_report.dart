...
class EventProfitReport extends StatelessWidget {
  const EventProfitReport({super.key});
    ...
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: Column(
          children: [
            searchField(kSize),
            todayProfileTile(kSize),
            listHeader(kSize),
            listingProfit(kSize, context),
          ],
        ),
      ),
    );
  ...
  Widget todayProfileTile(Size kSize) {
    return Container(
  ...
  Widget listingProfit(Size kSize, BuildContext context) {
    return Expanded(
