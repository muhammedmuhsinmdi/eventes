...
class DashBoardNaVBar extends StatelessWidget {
  ...
  DashBoardNaVBar({super.key, required this.selectedIndex, required this.onSelected});

  final List<String> adminBottomNavIcons = [
    AppImages.calender,
    AppImages.coin,
  ...
  final List<String> adminBottomNavLabels = [
    "EVENTS",
    "PAYMENT",
    "PROFILE",
    "SCAN QR",
