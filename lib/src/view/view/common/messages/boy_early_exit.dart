...
class BoyEarlyExit extends StatelessWidget {
  const BoyEarlyExit({super.key});
              ...
              children: [
                Flexible(
                  child: FooterButton(
                      ...
                      onTap: () {
                        ...
                        // Navigator.pushNamed(context, RouterConstants.boyExitRecordRoute);
                      }),
                ),
                const SizedBox(
                ...
                Flexible(
                  child: FooterButton(
                      ...
                      onTap: () {
                        //
                        Navigator.pushNamed(context, RouterConstants.adminAmtReceievedRoute);
                      }),
                ),
              ],
            ),
  ...
  Widget messageIcon(Size kSize) {
    return SvgPicture.asset(
      AppImages.msgWarning,
      height: kSize.height * 0.1,
      colorFilter: const ColorFilter.mode(AppColors.statusWarning, BlendMode.srcIn),
    );
  }
