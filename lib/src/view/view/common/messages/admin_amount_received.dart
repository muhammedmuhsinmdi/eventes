...
class AdminAmoutRecieved extends StatelessWidget {
  const AdminAmoutRecieved({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            FooterButton(
                ...
                onTap: () {
                  //
                  Navigator.pushNamed(context, RouterConstants.admineventRemoveBoyRoute);
                }),
            const Spacer(),
          ],
        ),
