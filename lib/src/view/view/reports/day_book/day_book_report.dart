        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                index % 2 == 0 ? '-76734' : "63746",
                style: AppTypography.poppinsMedium.copyWith(
                  color: index % 2 == 0 ? AppColors.statusCritical : AppColors.secondaryColor,
                  fontSize: 14,
                ),
              ),
            ],
