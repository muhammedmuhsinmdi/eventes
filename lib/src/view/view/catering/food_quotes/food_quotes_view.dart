...
class FoodQuotesView extends StatelessWidget {
  const FoodQuotesView({super.key});
  ...
  AppBar appBar(BuildContext context, Size kSize) {
    return AppBar(
      ...
      centerTitle: true,
      title: Text(
        AppStrings.evantezFoodQuotesText,
        style: AppTypography.poppinsSemiBold.copyWith(
          color: AppColors.secondaryColor,
        ),
      ),
      actions: [
        IconButton(
          onPressed: () {
            //
            Navigator.pushNamed(context, RouterConstants.newFoodQuotesRoute);
          },
