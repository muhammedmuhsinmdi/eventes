...
class AssignEmployeeSheet {
  BuildContext parentContext;
  AssignEmployeeSheet(this.parentContext);
  ...
  Future<void> show() async {
    await showModalBottomSheet(
        ...
        builder: (context) {
          return const AsignningEmpSheet();
        });
  }
}

class AsignningEmpSheet extends StatefulWidget {
  const AsignningEmpSheet({super.key});

  @override
  State<AsignningEmpSheet> createState() => _AsignningEmpSheetState();
}

class _AsignningEmpSheetState extends State<AsignningEmpSheet> {
