...
class EventCompletedSlot extends StatelessWidget {
  final String eventStatus;

  EventCompletedSlot({super.key, required this.eventStatus});

  final ValueNotifier<bool> invoice = ValueNotifier<bool>(false);

  final List<InvoiceModel> types = [
    InvoiceModel("Invoice Amount", "40000"),
    InvoiceModel("Normal Wages", "(40000)"),
    InvoiceModel("Overtime Wages", "(40000)"),
    InvoiceModel("Overtime Wages", "(40000)"),
    InvoiceModel("Setting Work", "(40000)"),
  ];
